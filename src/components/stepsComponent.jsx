...
const StepsComponent = () => {
  return (
    <div className="steps__container">
      <div className="steps__header" data-aos="fade-in" data-aos-once="true" data-aos-offset="300">
        <h1 className="steps__title">Steps</h1>
        <p style={{ maxWidth: "initial" }} className="steps__text" data-aos="fade-in" data-aos-offset="300" data-aos-once="true" data-aos-duration='200'>
          Check the{" "}
      ...
      <div className="steps__content">
        <div className="steps__content--wrapper" data-aos="fade-left" data-aos-offset="300" data-aos-once="true" data-aos-duration='200' data-aos-delay='200'>
        ...
        <div className="steps__content--wrapper" data-aos="fade-left" data-aos-offset="300" data-aos-once="true" data-aos-duration='200' data-aos-delay='400'>
        ...
        <div className="steps__content--wrapper" data-aos="fade-left" data-aos-offset="300" data-aos-once="true" data-aos-duration='200' data-aos-delay='600'>
